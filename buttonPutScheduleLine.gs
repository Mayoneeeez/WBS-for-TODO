...
const scheduleLineResultMessage001 = "予定線挿入に成功しました。"
const scheduleLineErrorMessage001 = "予定線を挿入したい項番を1つ以上選択してからボタンを押してください。";

//TODO
//共通要素はどこかで管理したい
async function putScheduleLine() {
  ...
  try {
    ...
    if (rowList.some(value => target.includes(value))) {
      throw new Error(scheduleLineErrorMessage001)
    }
